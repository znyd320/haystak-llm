from haystack.nodes import EmbeddingRetriever, PreProcessor, PromptTemplate
...
def get_result(query):
    ...
    prompt_model = PromptNode("gpt-3.5-turbo")
    ...
    pipeline.add_node(component=prompt_model, name="PromptNode", inputs=["Retriever"])
